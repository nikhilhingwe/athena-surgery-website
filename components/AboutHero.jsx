...
import { ArrowRight, ExternalLink } from "lucide-react";
import heroImg from "../public/assets/img/about-hero.avif";
import { Button } from "./ui/button";
      ...
      <div className="relative grid grid-cols-1 items-center gap-8 px-4 md:grid-cols-5 md:gap-12 lg:py-24 xl:gap-16 custom-container">
        ...
        >
          <div className="space-y-6 md:space-y-4">
            ...
            <h1 className="scroll-m-20 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
              <span className="block">Advanced Surgical</span>
              <span className="text-primary mt-1 block">Care in Stone Oak</span>
            </h1>

            <p className="text-muted-foreground max-w-xl mx-auto md:mx-0 text-[18px] md:text-[20px]">
              Welcome to Athena Surgery center located in Stone Oak San Antonio
              Texas. We are a state of the art day surgery center providing
              focused care in Plastic surgery, Pain Management and Orthopedics.
            </p>
